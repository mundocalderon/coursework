...
class Assignment
  ...
  def find_allusers(offset, limit)
      ...
      allusers = User.order(:updated_at).offset(offset).limit(limit)
  end
  ...
  def find_alllists(offset, limit)
      ...
      alllists = TodoList.all.order(list_due_date: :desc).offset(offset).limit(limit)
  end
  ...
  def find_user_byname(username)
      ...
      #users = User.find_by(username: username) => This returns the one User instead of collection
  end 
