...
class Solution
  ...
  def calculate_line_with_highest_frequency()
    ...
    @analyzers.each { |line_analyzer| @highest_count_across_lines = line_analyzer.highest_wf_count unless line_analyzer.highest_wf_count < @highest_count_across_lines }
  ...
  def print_highest_word_frequency_across_lines()
    ...
    @highest_count_words_across_lines.each_with_index { |line| puts "#{line.highest_wf_words} (appears in line #{line.line_number})"}
